...
const FloatingNav = ({ activeSection, setActiveSection, theme, isScrolled }) => {
  ...
  return (
    <motion.div 
      ...
      className={`fixed top-4 left-1/2 transform -translate-x-1/2 z-50 rounded-full shadow-lg ${isScrolled ? 'backdrop-blur-sm bg-white/80 dark:bg-gray-800/80' : 'bg-transparent'} transition-all duration-300`}
    >
